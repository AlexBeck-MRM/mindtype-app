/*╔══════════════════════════════════════════════════════════╗
  ...
  ║                                                            ║
  ╚══════════════════════════════════════════════════════════╝
  • WHAT ▸ Confidence gating for context/tone stages
  • WHY  ▸ REQ-CONFIDENCE-GATING
  • HOW  ▸ See linked contracts and guides in docs
*/

import { getConfidenceThresholds } from '../config/thresholds';
import { getConfidenceSensitivity, MAX_SWEEP_WINDOW } from '../config/thresholds';
...
export function applyThresholds(
  ...
  const inputFidelity =
    typeof score === 'number' ? thresholds.τ_input : score.inputFidelity;
