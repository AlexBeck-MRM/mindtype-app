...
import { createQwenTokenStreamer } from '../../../src/lm/transformersRunner';
...
async function getStreamer() {
  ...
  streamerPromise = (async () => {
    try {
      ...
      const wasmPaths = '/mindtype/wasm/';
      const localModelPath = '/mindtype/models/onnx-community/Qwen2.5-0.5B-Instruct';
