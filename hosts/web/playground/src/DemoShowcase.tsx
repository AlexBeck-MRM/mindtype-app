...
export const DEMO_CARDS: DemoCard[] = [
  {
    ...
    description:
      'Animated dot‑matrix correction entity with independent timing and rich controls, including 2D pads and a manual progress slider.',
  ...
  },
  {
    ...
    description:
      'The flagship interactive demo showcasing real-time text correction with AI language models. Experience the future of typing with prefilled fuzzy text examples, one-click corrections, and elegant braille animation feedback.',
    url: '/#/',
    category: 'main',
    features: [
  ...
  },
  {
    ...
    description:
      'Advanced language model testing laboratory with direct model interaction, prompt engineering tools, and performance diagnostics.',
    url: '/#/lab',
    category: 'lab',
    features: [
  ...
  },
  {
    ...
    description:
      'Visual demonstration of the active region concept with animated noise clusters and band swapping mechanics. Shows how text corrections flow through the processing pipeline.',
    url: '/demo/band-swap/',
    category: 'visual',
    features: [
  ...
  },
  {
    ...
    description:
      'Showcase of Unicode braille character animations and patterns. Demonstrates the visual feedback system used in text correction indicators.',
  ...
  },
  {
    ...
    description:
      'GSAP-powered scroll-triggered text animations with smooth scrolling and reveal effects. Demonstrates advanced typography and motion design principles.',
