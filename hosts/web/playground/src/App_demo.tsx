...
export default function DemoApp() {
  ...
  const [text, setText] = useState(
    'Welcome to Mind⠶Flow v0.6! This revolutionary typing intelligence system transforms typing from mechanical skill into fluid expression of thought. Type here and watch the Active Region highlight behind your cursor.',
  );
