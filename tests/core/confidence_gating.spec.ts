...
type ConfidenceThresholds = ReturnType<typeof getConfidenceThresholds>;
...
describe('Confidence Gating System', () => {
  ...
  describe('threshold application', () => {
    it('commits proposals above τ_commit threshold', () => {
      ...
      setConfidenceThresholds({ τ_commit: 0.8 });
      ...
      const dynamicThresholds = { ...base, τ_commit: 0.8, τ_discard: 0.3 };
  ...
  describe('demo-tuned thresholds', () => {
    ...
    it('uses lowered τ_commit for more visible corrections', () => {
      ...
      expect(thresholds.τ_commit).toBe(0.8);
    });
